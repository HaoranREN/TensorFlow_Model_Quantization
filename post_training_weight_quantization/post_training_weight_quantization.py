# -*- coding: utf-8 -*-
"""post_training_weight_quantization.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/119GkmswoaO4GZV5rQ5W9q8W2BlPeedYr
"""
...
train_model.save('/content/drive/My Drive/Colab Notebooks/quantization_github/post_training_weight_quantization_model/trained_model.h5')

# convert to quantized tf.lite model

converter = tf.lite.TFLiteConverter.from_keras_model_file('/content/drive/My Drive/Colab Notebooks/quantization_github/post_training_weight_quantization_model/trained_model.h5')

converter.optimizations = [tf.lite.Optimize.OPTIMIZE_FOR_SIZE]

tflite_model = converter.convert()
open('/content/drive/My Drive/Colab Notebooks/quantization_github/post_training_weight_quantization_model/quantized_model.tflite', 'wb').write(tflite_model)

# load the quantized tf.lite model and test

interpreter = tf.lite.Interpreter(model_path='/content/drive/My Drive/Colab Notebooks/quantization_github/post_training_weight_quantization_model/quantized_model.tflite')
